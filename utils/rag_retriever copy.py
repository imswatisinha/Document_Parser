...
# Cache the embedding model to avoid reloading (expensive operation)
...
class OllamaRAGRetriever:
    ...
    def setup_embedding_model(self):
        """Setup local embedding model for semantic search (cached for performance)."""
        try:
            # Try sentence-transformers first (best option) - CACHED
            if SENTENCE_TRANSFORMERS_AVAILABLE:
            ...
            pass  # Silently fail, try next option
